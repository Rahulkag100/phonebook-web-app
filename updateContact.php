...
<body>
        ...
        <div class="main-content">
            <div class="add-contact-form p-3">
                ...
                <?php
                    ...
                    $ans = "SELECT * FROM phonebook WHERE id = $id";
                ...
                <form id="add-form">
                    ...
                    ?>
                        <div class="form-row">
                            <div class="col-10">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="xyz@gmail.com" oninput="this.value = this.value.replace(/[^a-zA-Z0-9@.]/g, '').replace(/(\..*)\./g, '$1');" name="emails[]" value="<?php echo $emails[$i]; ?>">
                                </div>
                            </div>
                            <div class="col-2 text-center">
                                <button class="btn btn-add" id="<?php echo $btn_id; ?>"><i class="fa <?php echo $add_more; ?>"></i></button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.mobile-numbers').on('click', '#remove-mobile', function(e) { 
                e.preventDefault();
