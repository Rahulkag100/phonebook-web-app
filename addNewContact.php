...
<head>
    ...
    <title>PhoneBook-Add New Contact</title>
</head>
...
<body>
                ...
                <form id="add-form">
                    ...
                    <div class="emails">
                        <div class="form-row">
                            <div class="col-10">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="xyz@gmail.com"  oninput="this.value = this.value.replace(/[^a-zA-Z0-9@.]/g, '').replace(/(\..*)\./g, '$1');" name="emails[]" required>
                                </div>
                            </div>
                            <div class="col-2 text-center">
    ...
    <script>
        $(document).ready(function() {
            // Add mobile number input fields
            $('#add-numbers-input').click(function(e) {
                e.preventDefault();
                $('.mobile-numbers').append(`<div class="form-row" id="new-numbers-input">
                        <div class="col-10">
                            <div class="form-group">
                                <input type="text" class="form-control"  id="number" name="number[]" placeholder="+91 XXXXXXXXXX">
                            </div>
                        </div>
                        <div class="col-2 text-center">
