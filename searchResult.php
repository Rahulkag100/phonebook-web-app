<?php
    ...
    if(isset($_POST['search'])){
        ...
        // Query to Database
        $ans = "SELECT * FROM phonebook WHERE name LIKE '%$searchQuery%' UNION ";
        $ans .= "SELECT * FROM phonebook WHERE mobiles LIKE '%$searchQuery%' UNION ";
        $ans .= "SELECT * FROM phonebook WHERE emails LIKE '%$searchQuery%'ORDER BY name LIMIT $startIndex, $limit_per_page";
        ...
        <div class="Pagination justify-content-center mb-5 mt-3">';
                ...
                // Query to Database
                $ans1 = "SELECT * FROM phonebook WHERE name LIKE '%$searchQuery%' UNION ";
                $ans1 .= "SELECT * FROM phonebook WHERE mobiles LIKE '%$searchQuery%' UNION ";
                $ans1 .= "SELECT * FROM phonebook WHERE emails LIKE '%$searchQuery%'";
                $query2 = mysqli_query($connection, $ans1);
